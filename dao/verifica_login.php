...
/* Logo abaixo temos um bloco com if e else, verificando se a variável $result foi bem sucedida, zzzou 
seja se ela estiver encontrado algum registro idêntico o seu valor será igual a 1, se não,
